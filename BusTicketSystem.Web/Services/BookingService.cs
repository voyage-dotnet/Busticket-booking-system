...
public class BookingService : IBookingService
{
    ...
    public async Task<ApiResponse<List<int>>> GetBookedSeatNumbersAsync(int tripId)
    {
        var seats = await _bookingRepo.GetBookedSeatNumbersAsync(tripId);
        return ApiResponse<List<int>>.SuccessResponse(seats, "Booked seats fetched.");
    }
